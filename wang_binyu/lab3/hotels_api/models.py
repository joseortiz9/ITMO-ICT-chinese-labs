...
class Room(models.Model):
    ...
    reservations = models.ManyToManyField(settings.AUTH_USER_MODEL, through='Reservation')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class Reservation(models.Model):
    costumer = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
